        ...
        <Paper onClick={onClick} className='job'>
            <div className="flex-align-mid">
                <div className="job-title-location">
                    <Typography className="job-title-first" variant='h6'>{job.title}</Typography>
                    <Typography className="job-title-second" variant='h5'>{job.company}</Typography>
                    <Typography className="job-title-third">{job.location}</Typography>
                </div>
            </div>
            <div className="flex-align-mid">
                <Typography className="job-date" >{makeDate(job.created_at)}</Typography>
            </div>
        </Paper>
    )
}